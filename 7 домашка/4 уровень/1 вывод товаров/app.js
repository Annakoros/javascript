...
let activeProduct = document.querySelector('.products');
...
function showCategory(category) {
    ...
    switch (category) {
        case "phones":
            prod = products.phones;
            break;
        case "tablets":
            prod = products.tablets;
            break;
        case "tv":
            prod = products.tv;
            break;
    ...
    for (let i = 0; i < prod.length; i++) {
        activeProduct.insertAdjacentHTML('beforeend', `${getProductMarkup(prod[i])}`);
    }
